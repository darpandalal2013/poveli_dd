...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field clients on 'UserProfile'
        db.create_table(u'user_profile_clients', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['accounts.userprofile'], null=False)),
            ('client', models.ForeignKey(orm['client.client'], null=False))
        ))
        db.create_unique(u'user_profile_clients', ['userprofile_id', 'client_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field clients on 'UserProfile'
        db.delete_table('user_profile_clients')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'clients': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'profiles_of_users_with_access'", 'symmetrical': 'False', 'to': "orm['client.Client']"}),
